...
function sort() {
  ...
  function categoryItemSize() {
    // if (window.innerWidth > 991) {
    sortSearchForCategoryItem.forEach(item => {
      let border = item.querySelector('.border'),
          borderWidth = getComputedStyle(border).width.match(/\d+/),
          newBorderWidth = borderWidth * (100 / 1280);
      border.style.width = "".concat(newBorderWidth, "vw");
    }); // } 
    // else {
    //     sortSearchForCategoryItem.forEach(item => {
    //         let border = item.querySelector('.border'),
    //             borderWidth = getComputedStyle(border).width.match(/\d+/),
    //             newBorderWidth = borderWidth * (100 / 414);
    //             border.style.width = `${newBorderWidth}vw`;
    //         // let borderHeight = getComputedStyle(border).height.match(/\d+/),
    //         //     newBorderHeight = borderHeight * (100 / 1280);
    //         //     border.style.height = `${newBorderHeight}vw`;
    //     });
    // }
  }

  categoryItemSize(); // window.addEventListener(`resize`, () => {categoryItemSize();});
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_sort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/sort */ "./src/js/modules/sort.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_sort__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/***/ 0:
/*!************************************************************************************!*\
  !*** multi ./src/js/script.js ./src/js/modules/slider.js ./src/js/modules/sort.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
