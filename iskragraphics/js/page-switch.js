$(document).ready(function() {
	$('.i1').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'ecoride.html');
		}, 1000);
	...
	$('.i2').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'rmetre.html');
		}, 1000);
	...
	$('.i3').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'yetikids.html');
		}, 1000);
	...
	$('.i4').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'restavrator.html');
		}, 1000);
	...
	$('.i5').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'odyssey.html');
		}, 1000);
	...
	$('.i7').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'sivart.html');
		}, 1000);
	...
	$('.i8').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'planar.html');
		}, 1000);
	...
	$('.i9').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'porteryard.html');
		}, 1000);
	...
	$('.i10').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'magiccorn.html');
		}, 1000);
	...
	$('.i12').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'whaleberry.html');
		}, 1000);
	...
	$('.i13').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'everest.html');
		}, 1000);
	...
	$('.i14').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'adelun.html');
		}, 1000);
	...
	$('.i15').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'tennosushi.html');
		}, 1000);
	...
	$('.i16').click(function(){
		...
		setTimeout(function(){
			$(location).attr('href', 'vitamins.html');
		}, 1000);
