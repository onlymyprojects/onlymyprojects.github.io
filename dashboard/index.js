...
var mChart = new Chart('m-chart_6', {
  type: 'doughnut',
  data: {
    datasets: [{
      data: [40.69, 40.69, 18.62],
...
var mChart = new Chart('m-chart_7', {
  type: 'doughnut',
  data: {
    datasets: [{
      data: [40.69, 40.69, 18.62],
...
var mChart = new Chart('m-chart_8', {
  type: 'doughnut',
  data: {
    datasets: [{
      data: [40.69, 40.69, 18.62],
...
function openStatistics(id, doughnutId) {
  ...
  if (el.classList.contains('active' || 'm-active')) {
    el.classList.remove('active' || 'm-active');
    doughnut.classList.add('active' || 'm-active');
  }

  if (doughnut.classList.contains('active' || 'm-active')) {
    doughnut.classList.remove('active' || 'm-active');
    doughnut.classList.add('non-active' || 'm-non-active');
    el.classList.add('active' || 'm-active')
  }
}
...
const mTrafic = document.getElementById('Mtraffic')

console.log(mTrafic);

function hideAndShowMenu(item) {
